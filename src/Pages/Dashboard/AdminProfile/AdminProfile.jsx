...
const AdminProfile = () => {
  ...
  const handleDownloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Admin Stats");
    XLSX.writeFile(workbook, "AdminStats.xlsx");
  };
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="flex justify-end mb-6">
        <button
          ...
          className="bg-indigo-700 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded"
        >
          Download Excel
        </button>
      </div>
